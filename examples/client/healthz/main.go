...
var (
	// 定义命令行参数
	addr = flag.String("addr", "localhost:9090", "The grpc server address to connect to.") // gRPC 服务的地址
...
func main() {
	...
	// 创建 MiniBlog 客户端
	//client := apiv1.NewEasyBlogClient(conn) // 使用连接创建一个 MiniBlog 的 gRPC 客户端实例
